...
st.write(
    "Carregue o ficheiro DMR em TXT e o Excel com situações pendentes. "
    "O sistema procura o NIF, identifica linha de categoria A elegível "
    "(A21 excluída), aplica a diminuição e devolve TXT corrigido, Excel atualizado e resumo."
)
